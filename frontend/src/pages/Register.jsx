    ...
    return (
        <div className='flex flex-col md:flex-row min-h-screen items-center justify-center bg-gray-50'>
            ...
            <div className='flex flex-col justify-center items-center w-full md:w-1/2 p-6 md:p-16'>
                <div className='w-full max-w-md border border-gray-200 bg-white p-8 rounded-2xl shadow-sm'>
                    <div className='text-center'>
                        ...
                        <p className='text-gray-500 text-sm mb-8'>Enter your name email and password to resgister.</p>
                    </div>

                    <form className='space-y-4' onSubmit={handelSubmit}>
                        <div className='flex flex-col'>
                            <label className='mb-1.5 font-semibold text-sm text-gray-700'>Name</label>
                            <input
                                type="text"

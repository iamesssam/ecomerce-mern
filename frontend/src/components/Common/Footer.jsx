...
//         px-5 py-5 border-t justify-items-center 
//         '>
//                 {/* Section 1 */}
//                 <div>
//                     <h2 className='mb-3 font-bold'>NewsLetter</h2>
//                     <p className='text-sm mb-3 text-gray-700'>Be the first to hear,about new products, <br />
//                         exclusive events, and online offers. <br />
//                     </p>
...
//                         py-1 px-3 placeholder:text-sm rounded
//                         ' />
//                         <button type='submit'
...
//                         <p className='mb-2 text-gray-900 cursor-pointer'>Men's Top Wear</p>
//                         <p className='mb-2 text-gray-900 cursor-pointer '>Women's Top Wear</p>
//                         <p className='mb-2 text-gray-900 cursor-pointer '>Men's Bottom Wear</p>
//                         <p className='mb-2 text-gray-900 cursor-pointer '>Women's Bottom Wear</p>
//                     </div>
//                 </div>
...
//                     <div className='text-sm mt-3'>
//                         <p className='mb-2 text-gray-900 cursor-pointer '>Contact Us</p>
//                         <p className='mb-2 text-gray-900 cursor-pointer '>About Us</p>
//                         <p className='mb-2 text-gray-900 cursor-pointer '>FAQs</p>
//                         <p className='mb-2 text-gray-900 cursor-pointer '>Features</p>
//                     </div>
//                 </div>
...
//                             <TbBrandMeta className='mr-2 cursor-pointer ' />
//                         </a>
//                         <a href="https://www.instagram.com" target='_blank'>
//                             <IoLogoInstagram className='mr-2 cursor-pointer ' />
//                         </a>
